  ...
  <div class="container mx-auto p-6">
    <div>
        <div class="flex justify-between">
            ...
            {{-- Time --}}
            <div class="border-violet flex gap-10">

                <h1 class="font-semibold mt-3">Time to submission</h1>
                <div class="flex gap-5">
                    <div>
                        <p class="bg-[#EEEEEE] flex border-2 border-[#012970] p-2 text-semibold">15</p>
                        <p>Hours</p>
                    </div>
                    :
                    <div>
        ...
        @php
            ...
            $increaseRate = 12;
            $submittedReports = 1;
            $lastHeading = "Submitted Reports"   // Example increase rate
        @endphp
